...
public class SentenciadorSQL extends SQLiteOpenHelper {
    ...
    String pedido = "CREATE TABLE Pedidos (id_pedido INTEGER PRIMARY KEY , id_cliente INTEGER, precio_total INTEGER," +
    ...
    String lineas = "CREATE TABLE Lineas (id_linea INTEGER  , id_pedido INTEGER ,id_tipokebab INTEGER,id_tipocarne INTEGER," +
            "id_tipotamaño INTEGER, id_bebida INTEGER, cantidad INTEGER, precio INTEGER, PRIMARY KEY(id_linea,id_pedido),FOREIGN KEY(id_pedido) REFERENCES Pedidos(id_pedido)ON DELETE CASCADE," +
